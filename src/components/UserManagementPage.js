...
const UserManagementPage = ({ users, onRefresh, currentUserId }) => {
  ...
  // ✅ UPDATED: Added role field with default 'user'
  ...
  const getRoleBadge = (role) => {
    switch (role) {
      case 'admin':
        return { bg: 'rgba(250, 112, 154, 0.2)', color: '#fa709a', label: 'Admin' };
      case 'editor':
        return { bg: 'rgba(102, 126, 234, 0.2)', color: '#667eea', label: 'Editor' };
      default:
        return { bg: 'rgba(148, 163, 184, 0.2)', color: '#64748b', label: 'User' };
    }
  };
  ...
  return (
    <div className="space-y-5">
      ...
      {/* ✅ UPDATED Stats Cards - Now show Admin/Editor/User counts */}
